  ...
  groups: [
    ...
    },
    {
      ...
      links: [
        ...
        { label: '主理人介绍', href: '/zh/about/founder/' },
        { label: '会员服务', href: '/zh/membership/' },
        { label: '活动与考察', href: '/zh/events/' },
...
export const projectsPage = {
  ...
  active: {
    ...
    items: [
      {
        name: '4136 Rosewood｜洛杉矶 East Hollywood · ED1 经济适用房开发',
        ...
        positioning: '符合 ED1 政策的洛杉矶城市住宅开发产品，单元面向 LA 区域工薪与中等收入家庭。',
  ...
  entry: {
    ...
    items: [
      ...
      },
      {
        ...
        fee: '具体费用机制按合作协议约定；涉及金融、保险等产品由相应合规主体提供。',
