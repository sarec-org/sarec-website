...
const productPackages = [
  ...
  {
    title: '投资结构与合作方案设计',
    fit: '需要设计 LP / GP 结构、项目分成、管理费、退出机制、投资人沟通机制的项目方或合作伙伴。',
    solve: ['钱怎么进？', '谁来管？', '收益怎么分？', '风险怎么控？', '投资人如何获得透明信息？'],
